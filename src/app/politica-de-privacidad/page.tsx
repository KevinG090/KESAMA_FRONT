...
const sections = [
  ...
  { id: 'derechos', title: '6. Sus derechos como titular' },
  { id: 'procedimiento', title: '7. Cómo ejercer sus derechos' },
  { id: 'terceros', title: '8. Transferencia a terceros' },
  { id: 'seguridad', title: '9. Seguridad de la información' },
  { id: 'menores', title: '10. Menores de edad' },
  { id: 'cookies', title: '11. Cookies y tecnologías de rastreo' },
  { id: 'vigencia', title: '12. Vigencia y modificaciones' },
  { id: 'autoridad', title: '13. Autoridad de control' },
]
  ...
  return (
    ...
    >
      ...
      <LegalSection id="datos" title="3. Datos que recolectamos">
        ...
        <ul>
          <li>
            <strong>Formulario de newsletter</strong> (pie de página): correo electrónico.
          </li>
          <li>
      ...
      <LegalSection id="finalidades" title="4. Finalidades del tratamiento">
        ...
        <ul>
          ...
          <li>Enviar información comercial o boletines, si usted se suscribió voluntariamente al newsletter;</li>
      ...
      <LegalSection id="autorizacion" title="5. Autorización del titular">
        <p>
          El tratamiento de sus datos personales requiere su autorización previa, expresa e informada. Al
          suscribirse al newsletter o al iniciar una conversación de WhatsApp desde este sitio, usted autoriza a{' '}
          {siteConfig.companyName} a tratar los datos que voluntariamente comparta para las finalidades descritas en
          esta política.
        </p>
      </LegalSection>

      <LegalSection id="derechos" title="6. Sus derechos como titular">
      ...
      <LegalSection id="procedimiento" title="7. Cómo ejercer sus derechos">
        <p>
      ...
      <LegalSection id="terceros" title="8. Transferencia a terceros">
        <p>
      ...
      <LegalSection id="seguridad" title="9. Seguridad de la información">
        <p>
      ...
      <LegalSection id="cookies" title="11. Cookies y tecnologías de rastreo">
        <p>
      ...
      <LegalSection id="vigencia" title="12. Vigencia y modificaciones">
        <p>
      ...
      <LegalSection id="autoridad" title="13. Autoridad de control">
        <p>
